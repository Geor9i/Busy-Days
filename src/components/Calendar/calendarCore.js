...
export default class CalendarCore {
  ...
  //           "date",
  //           `${colCollection[col].innerText}/${dateValues.month}/${dateValues.year} - ${this.util.getWeekDays(col)}`
  //         );
  //         prevMonthIndex++;
  //       }
  //       //if the two weekdays match confirm in boolean
  //       if (this.util.getWeekDays(col) === selectedMonth[0][1]) {
  //         isCurrent = true;
  //       }
  ...
  //         colCollection[col].setAttribute(
  //           "date",
  //           `${colCollection[col].innerText}/${month + 1}/${year} - ${this.util.getWeekDays(col)}`
  //         );
  //       }
  //     }
  //   }
  ...
  calendarMonth(year, month) {
    ...
    let daysOfWeek = this.util.getWeekDays([]);
