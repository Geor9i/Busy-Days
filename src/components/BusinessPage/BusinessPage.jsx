...
const addPositionHandler = (e) => {
  ...
  <form method="POST" className={styles['form']}>
                ...
                <div className={styles['opening-times-window-container']}>
                  <div className={styles['opening-times-window-sub-container']}>
                    <div className={styles['time-window']}>
                      ...
                      <input type="text" id="open-monday" name="open-monday" />
                    </div>
                    <div className={styles['time-window']}>
                      <label htmlFor="close-monday">close</label>
                      <input type="text" id="close-monday" name="close-monday" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className={styles['opening-times-window-container']}>
                  <div className={styles['opening-times-window-sub-container']}>
                    <div className={styles['time-window']}>
                      ...
                      <input type="text" id="open-tuesday" name="open-tuesday" />
                    </div>
                    <div className={styles['time-window']}>
                      <label htmlFor="close-tuesday">close</label>
                      <input type="text" id="close-tuesday" name="close-tuesday" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className={styles['opening-times-window-container']}>
                  <div className={styles['opening-times-window-sub-container']}>
                    <div className={styles['time-window']}>
                      ...
                      <input type="text" id="open-wednesday" name="open-wednesday" />
                    </div>
                    <div className={styles['time-window']}>
                      <label htmlFor="close-wednesday">close</label>
                      <input type="text" id="close-wednesday" name="close-wednesday" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className={styles['opening-times-window-container']}>
                  <div className={styles['opening-times-window-sub-container']}>
                    <div className={styles['time-window']}>
                      ...
                      <input type="text" id="open-thursday" name="open-thursday" />
                    </div>
                    <div className={styles['time-window']}>
                      <label htmlFor="close-thursday">close</label>
                      <input type="text" id="close-thursday" name="close-thursday" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className={styles['opening-times-window-container']}>
                  <div className={styles['opening-times-window-sub-container']}>
                    <div className={styles['time-window']}>
                      ...
                      <input type="text" id="open-friday" name="open-friday" />
                    </div>
                    <div className={styles['time-window']}>
                      <label htmlFor="close-friday">close</label>
                      <input type="text" id="close-friday" name="close-friday" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className={styles['opening-times-window-container']}>
                  <div className={styles['opening-times-window-sub-container']}>
                    <div className={styles['time-window']}>
                      ...
                      <input type="text" id="open-saturday" name="open-saturday" />
                    </div>
                    <div className={styles['time-window']}>
                      <label htmlFor="close-saturday">close</label>
                      <input type="text" id="close-saturday" name="close-saturday" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className={styles['opening-times-window-container']}>
                  <div className={styles['opening-times-window-sub-container']}>
                    <div className={styles['time-window']}>
                      ...
                      <input type="text" id="open-sunday" name="open-sunday" />
                    </div>
                    <div className={styles['time-window']}>
                      <label htmlFor="close-sunday">close</label>
                      <input type="text" id="close-sunday" name="close-sunday" />
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div className={styles['role-hierarchy-container']}>
      ...
      <button onClick={addPositionHandler} className={styles['add-position']}>New position</button>
      <table className={styles['role-hierarchy-table']}>
        <thead>
          <tr>
            <th className={styles['role-hierarchy-th']}>Role title</th>
            <th className={styles['role-hierarchy-th']}>Responsibility</th>
            <th className={styles['role-hierarchy-th']}>Role is flexible</th>
            <th className={styles['role-hierarchy-th']}>Can work as</th>
          </tr>
        </thead>
        <tbody>
         <PositionHierarchyListItem styles={styles} />
        </tbody>
      </table>
    </div>
    <div className={styles['role-hierarchy-container']}>
